...
def pressure_loss_from_pipe(pipe_diameter,
    ...
    pressure_loss = \
        (-friction_factor * pipe_length * WATER_DENSITY * fluid_velocity**2) / (2000*pipe_diameter)
    return pressure_loss
    
def pressure_loss_from_fittings(
        fluid_velocity, quantity_fittings):
    pressure_loss_fitting = \
    (-0.04 * WATER_DENSITY * fluid_velocity**2 * quantity_fittings) / 2000
...
# Defining the values outside of the function 
