...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        if symbol in periodic_table_dict:
            ...
            # print (f"Value: {value}") #TEST PRINT
            # print (f"Mass: {atomic_mass}") # TEST PRINT
            # print (f"Quantity: {quantity}") #TEST PRINT

        # Multiply the atomic mass by the quantity.            
            product = atomic_mass * quantity
            #print (f"product: {product}") #TEST PRINT
            
        # Add the product into the total molar mass.
    #product += product
            total_molar_mass += product
           # print (f"Total: {total_molar_mass}") #TESTPRINT
...
def get_formula_name(formula, known_molecules_dict):
    ...
    if formula in known_molecules_dict:
        ...
        print (f"Chemical Compound Name: {value.title()}")
    else:
